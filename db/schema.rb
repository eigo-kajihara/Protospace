...
ActiveRecord::Schema.define(version: 20180905061606) do
  ...
  add_index "tags", ["tag_list"], name: "index_tags_on_tag_list", using: :btree
  ...
  create_table "view_tags", force: :cascade do |t|
    t.integer  "prototype_id", limit: 4
